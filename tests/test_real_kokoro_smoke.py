...
Skipped unless READALOUD_REAL_TTS=1 is set in the environment. Produces a
...
from readaloud.models import ensure_artifacts
from readaloud.player import Player
from readaloud.providers.kokoro import KokoroProvider


pytestmark = pytest.mark.skipif(
    os.environ.get("READALOUD_REAL_TTS") != "1",
    reason="set READALOUD_REAL_TTS=1 to run the real-Kokoro smoke test",
)
